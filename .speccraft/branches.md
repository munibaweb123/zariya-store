...
| 06 | `feature/frontend/checkout-page` | `.speccraft/phases/frontend/06-checkout-page.md` | infra/02, frontend/03, frontend/05 | Ready (stub only — needs `/sc.plan` detailing) |

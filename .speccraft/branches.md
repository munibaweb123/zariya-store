...
| 02 | `feature/frontend/category-listing-page` | `.speccraft/phases/frontend/02-category-listing-page.md` | infra/01, infra/02, frontend/01 | Ready (stub only — needs `/sc.plan` detailing) |
